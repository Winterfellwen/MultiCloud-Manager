...
import { idleResourceRoutes } from './routes/idle-resources.js';
...
await app.register(silenceRoutes, { prefix: '/monitor' });
await app.register(idleResourceRoutes, { prefix: '/monitor' });
await app.register(budgetRoutes, { prefix: '/monitor' });
